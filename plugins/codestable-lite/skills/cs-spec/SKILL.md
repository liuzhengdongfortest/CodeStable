...
把当前理解写进正确层级的 spec：项目主线进入 `.cs/spec/`，大需求变更线进入 `.cs/epics/YYYY/MM/DD/{slug}/spec.md`。
...
- 大需求、跨模块变更、会分多批 issue、规格会反复变化 → 更新 `.cs/epics/YYYY/MM/DD/{slug}/spec.md`。
...
- `.cs/epics/YYYY/MM/DD/{slug}/index.md`
- `.cs/epics/YYYY/MM/DD/{slug}/spec.md`
- `.cs/epics/YYYY/MM/DD/{slug}/plan.md`
