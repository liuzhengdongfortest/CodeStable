...
<tr><td><b>计划入口</b></td><td><code>cs-plan</code></td><td>读取 <code>talks/</code> 或 epic spec 的本轮可计划范围，生成独立 issue、新 epic 或 epic issue</td></tr>
...
═══════════════════════════════════════════════════════════════
   ...
   搭骨架              查上下文 + talks│      project/epic│      生成事项 → 设计 issue → 可选测试 → 执行验证 → 按归属沉淀
...
───────────────────────────────────────────────────────────────
   ...
   cs-plan      ─▶ 从 talks 或 epic spec 判断：独立 issue / 新 epic / 本轮 epic issue
═══════════════════════════════════════════════════════════════
