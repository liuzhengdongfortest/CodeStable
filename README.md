...
<tr><td><b>设计入口</b></td><td><code>cs-design</code></td><td>面向单个 issue 做教程式实现设计，写回功能分工、请求/数据流、设计侧重点、边界、改动路线和验证</td></tr>
...
───────────────────────────────────────────────────────────────
   ...
   cs-design ──▶ 针对单个 issue 做实现设计（功能分工 / 请求数据流 / 设计侧重点 / 边界 / 改动路线 / 验证）
