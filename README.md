...
<tr><td><b>讨论入口</b></td><td><code>cs-brainstorm</code></td><td>想法模糊时的讨论 + 分诊：聊清楚后路由到直接写或 cs-epic</td></tr>
<tr><td rowspan="3"><b>横切 & 周边</b></td><td><code>cs-keep</code></td><td>坑点 / 技巧 / 决策 / 调研沉淀到 <code>compound/</code>，纯 markdown，grep 检索</td></tr>
...
═══════════════════════════════════════════════════════════════
            ▼ 任意时刻"这个值得记下来" ▼
 横切 · 知识沉淀（复利工程）
   cs-keep ──▶ .codestable/compound/   纯 markdown，grep 检索
...
│   │
│   ├── compound/             # 知识沉淀，纯 markdown，grep 检索（cs-keep）
│   │   └── YYYY-MM-DD-{slug}.md
│   │
│   ├── brainstorms/          # 大需求探索记录（cs-brainstorm，lazy）
...
- `compound/` 是知识沉淀，纯 markdown 无 frontmatter，靠 `grep -r` 检索——好写好搜
