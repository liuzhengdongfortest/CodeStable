...
- **`cs-design`** —— 针对单个 issue 做人能读懂的实现设计：设计结论、代码形状、边界、顺序和验证风险
...
<tr><td><b>设计入口</b></td><td><code>cs-design</code></td><td>面向单个 issue 做人能读懂的实现设计，写回设计结论、代码形状、边界、顺序和验证风险</td></tr>
...
───────────────────────────────────────────────────────────────
   ...
   cs-design ──▶ 针对单个 issue 做实现设计（结论 / 代码形状 / 边界 / 顺序 / 验证）
