...
4. **对齐 requirement**——本 feature 是在实现 / 修改哪个能力？到 `easysdd/requirements/` 下 Glob + grep 一遍，三种情况分别处理：
...
5. **归档检索**——值不值得搜、优先搜哪些目录，规则在 `easysdd/reference/shared-conventions.md` 第 5 节。本阶段至少考虑这两个目录：
